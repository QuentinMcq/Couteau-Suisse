<x-jet-form-section submit="updatePassword">
    <x-slot name="title">
        <button class="sr-only">Changer le mot de passe</button>

        {{ __('Changer le mot de passe') }}
    </x-slot>

    <x-slot name="description">
        <button class="sr-only">Utilisez un mot de passe long et sécurisé.</button>

        {{ __('Utilisez un mot de passe long et sécurisé.') }}
    </x-slot>
